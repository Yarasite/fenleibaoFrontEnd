<template>
	<div id="container">
		...
		<div class="box">
			<FInput title="装载垃圾重量:" placeholder="输入数字" unit="t" v-model="weight">
			</FInput>
			<FInput title="垃圾去向:" placeholder="输入垃圾处理厂名称" v-model="weight">
			</FInput>

			<!-- 要对该项进行检查，确保是已注册垃圾处理厂 -->
		</div>
		<div class="button">
			<button class="confirm" @click="handleConfirmThrow">确认装载</button>
